	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/August31st",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/39567360",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://discord.gg/3yUWhNUvZS",
		},
	],
};
